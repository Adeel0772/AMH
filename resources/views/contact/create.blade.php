...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('cascadefolder/css/img/favicon.ico')}}">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="{{asset('cascadefolder/css/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn f-right d-none d-lg-block ml-30">
                                    <a href="#" class="btn header-btn">AMH</a>
                                </div>
                            </div>
                        </div>   
                        <!-- Mobile Menu -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="msg"></label>
                                        <textarea class="form-control w-100" name="msg" id="msg" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Enter Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{asset('cascadefolder/img/logo/logo2_footer.png')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
