...
<body>
  ...
  <h2 class='mt-4 mb-4 text-center doctor-dashboard-title'>Welcome to ADMIN Dashboard</h2>
  <div class="row">
    <div class="col-12 position-relative">
      ...
      <div class="heroContent position-absolute top-50 start-50 translate-middle" >
        ...
        <a href="{{route('doctor.register')}}"><button class="btn btn-primary">ADD DOCTOR</button> </a>
        <a href="{{route('report.create')}}"><button class="btn btn-primary">CREATE REPORT</button> </a>
        <a href="{{route('report.read')}}"><button class="btn btn-primary">READ REPORT</button> </a>
        <a href="{{route('addappointment.chart')}}"><button class="btn btn-primary">SHOW CHART</button> </a>
